  ...
  return (
    <>
      <div className="relative z-1">
        ...
        <span
          className="fas fa-eye-slash absolute top-10 right-[5%] text-dark900  hidden cursor-pointer" role="hide password"
          onClick={handleClick}>
          {" "}
          Hide
        </span>
        <span
          className="fas fa-eye absolute top-10 right-[5%] text-dark900  cursor-pointer"
          onClick={handleClick}>
          Show
        </span>
