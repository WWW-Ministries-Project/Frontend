  ...
  return (
    <>
      <div className="relative z-1">
        ...
        <span
          className="fas fa-eye-slash absolute top-10 right-[5%] text-mainGray  hidden cursor-pointer" role="hide password"
          onClick={handleClick}>
          {" "}
          Hide
        </span>
        <span
          className="fas fa-eye absolute top-10 right-[5%] text-mainGray  cursor-pointer"
          onClick={handleClick}>
          Show
        </span>
