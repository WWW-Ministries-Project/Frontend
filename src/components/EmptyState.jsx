...
const SCOPE_CONFIG = {
  page: {
    ...
    rootClass:
      "mx-auto my-6 w-full max-w-4xl rounded-3xl border border-lightGray bg-gradient-to-br from-white via-[#F7F9FF] to-[#ECF1FF] px-6 py-10 shadow-sm sm:px-10",
    layoutClass: "flex flex-col items-center text-center",
    mediaClass:
      "h-32 w-32 rounded-3xl border border-lightGray/70 bg-white p-4 shadow-[0_12px_30px_rgba(8,13,45,0.12)] sm:h-36 sm:w-36",
  ...
  section: {
    ...
    rootClass:
      "mx-auto w-full rounded-2xl border border-dashed border-lightGray bg-gradient-to-r from-white via-[#F8F9FC] to-[#F2F5FF] px-5 py-6 sm:px-6",
    layoutClass:
      "flex flex-col items-center gap-4 text-center sm:flex-row sm:items-start sm:gap-6 sm:text-left",
    mediaClass:
      "h-20 w-20 rounded-2xl border border-lightGray/70 bg-white p-3 shadow-[0_10px_24px_rgba(8,13,45,0.08)]",
