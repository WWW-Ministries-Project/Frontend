  ...
  return (
    <section className="flex items-center justify-between px-4 text-dark900">
      <div className="flex flex-col gap-4">
        ...
        <SignatureSection label="Requested by" name="Tuffour Boateng" signature="https://www.jsign.com/wp-content/uploads/2022/06/graphic-signature-angle.png.webp" /> 
        <SignatureSection label="Received by" name="Saah Asiedu" signature="S.A" />
      </div>
