        ...
        <div className="w-full relative">
            ...
            <div className="absolute bottom-0 left-0 w-full h-48 flex items-center justify-between px-2">
                <div className='flex gap-4 items-center'>
                    <ProfilePic className="w-40 h-40 shadow" src={props.src} alt="cover Image" name={props.name} />
                    <article>
                ...
                <div>
                    <Button value={"Edit Profile"} onClick={() => {}} className="w-full mt-2 p-2 bg-transparent h-8 border " />
                </div>
