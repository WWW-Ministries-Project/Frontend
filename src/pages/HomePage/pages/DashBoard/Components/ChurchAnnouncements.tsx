  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h3 className="text-xl font-semibold text-gray-800">Church Announcements & News</h3>
      </div>
      ...
      <div className="text-center py-12">
        ...
        <p className="text-gray-500">Check back soon — any new announcements will appear here.</p>
      </div>
    </div>
  );
};