...
const SideBar = ({ show, ...props }) => {
    ...
    return (
        ...
        <div className={`min-h-screen text-white fixed z-10 bg-white shadow-xs  } ${!show ? "w-10 min-w-[40px]" : "w-[15%] min-w-[200px]"} transition-all duration-400  
            ...
            <span
                className={` absolute gradientBtn h-6 w-6 rounded-full flex items-center py-0 px-2 shadow-md z-40 m-8 top-10 hideNav ${show ? "left-[80%]" : "left-0"} `} onClick={handleClick}>
